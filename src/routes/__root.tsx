...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "BIZZ AUTOMATORS provides a modular business management platform for retail, inventory, point of sale, finance, and operations." },
      { name: "keywords", content: "business management software, POS system, inventory management, accounting, invoicing, retail operations, BIZZ AUTOMATORS" },
      ...
      { property: "og:description", content: "BIZZ AUTOMATORS brings POS, inventory, finance, and reporting together in one modern business management platform." },
      ...
      { name: "twitter:description", content: "Modern business management for retail, inventory, POS, finance, and reporting." },
      ...
      { name: "twitter:site", content: "BIZZ AUTOMATORS" },
      {
        "script:ld+json": {
          ...
          "description": "BIZZ AUTOMATORS provides a modular platform for retail, inventory, POS, finance, and operations management.",
          "sameAs": [],
          "contactPoint": {
            "@type": "ContactPoint",
